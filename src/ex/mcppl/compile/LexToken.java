...
public class LexToken {
    ...
    private char[] c;
    private ArrayList<TokenD> tds = new ArrayList<>();
    ...
    public LexToken(String data,short cs){
            ...
            do {
                ...
                if(c=='\\'){
                    ...
                    if(c == 'n'){
                        ...
                        sb.append("\"");
                    }else throw new VMException("Unknown escape sequence.");
                    continue;
                }
                sb.append((char) c);
            } while (c != '"');
    ...
    public ArrayList<TokenD> launch(){
        try {
            TokenD td = null;
