...
public class AstBoolStatement extends AstLeaf{
    ...
    public ByteCode eval() throws VMException {
        ...
        else if(td.getData().equals("("))return new GroupByteCode(BoolExpression.calculate(BoolExpression.parseBoolExpr(tds)));
        else throw new VMException("Unknown type in boolean statement.");
    }
}
