...
public class GetValueList implements BasicLibrary {
    ...
    public ExObject invoke(HashMap<String, ExObject> values, Executor executor) throws VMRuntimeException {
        if(values.get("name")==null||values.get("var")==null)throw new VMRuntimeException("Not found function 'valuedict' value 'name' or 'var'");
        ...
        for(Function function:executor.getFunctions()){
            if(function.getName().equals(name)){
                ...
                if(obj==null)throw new VMRuntimeException("vm.valuedict : Not found function:'"+function.getName()+"' value:"+value+".");
                executor.push(obj);
            }
        }
        return new ExObject();
