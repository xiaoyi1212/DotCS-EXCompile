...
public class NotByteCode implements ByteCode{
    ...
    public void exe(Executor executor) throws VMRuntimeException {
        ...
        }else throw new VMRuntimeException("Cannot convert other types to Boolean types in not");
        if(!obj.getType().equals(ExObject.Type.BOOL))throw new VMRuntimeException("Cannot convert other types to Boolean types in not");
