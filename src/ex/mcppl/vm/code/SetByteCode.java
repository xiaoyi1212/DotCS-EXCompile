        ...
        try {
            ...
            for(ExValue value:AllValueBuffer.values){
                if(value.getName().equals(name)){
                    if(!value.getValue().getClass().isInstance(Return)) throw new VMRuntimeException("The new value of the variable does not match the original value type:"+name);
            ...
            e.printStackTrace();
            throw new VMRuntimeException("Create value throw exception:"+e.getLocalizedMessage());
        }
    }
}
